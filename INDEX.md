# 🗂️ System Index: LinkedIn Content OS

This document maps every file in the **LinkedIn Content OS** repository, outlining its role, target reader/agent, and references.

---

## 📂 Root Files
* [README.md](file:///home/abdulrahman/Projects/linkedin-content-os/README.md): Project vision, repository overview, directory roles, naming conventions, and roadmap.
* [INDEX.md](file:///home/abdulrahman/Projects/linkedin-content-os/INDEX.md): *This file.* The registry and cross-referencing map for all files.
* [WORKFLOW.md](file:///home/abdulrahman/Projects/linkedin-content-os/WORKFLOW.md): Step-by-step execution guide for developers and agents.
* [summary.md](file:///home/abdulrahman/Projects/linkedin-content-os/summary.md): The project update log, structural review, and repository rating.
...
## 📂 System Prompts & Guidelines (`/prompts`)
Contains rules, persona boundaries, target audience insights, and style parameters.

* [writing-style.md](file:///home/abdulrahman/Projects/linkedin-content-os/prompts/writing-style.md): Rules for voice, formatting, active/passive voice, hooks, and anti-phrases.
* [target-audience.md](file:///home/abdulrahman/Projects/linkedin-content-os/prompts/target-audience.md): Audience personas (Founders, Senior Developers, SMEs) and their specific pain points.
* [content-pillars.md](file:///home/abdulrahman/Projects/linkedin-content-os/prompts/content-pillars.md): Core themes and topics (monoliths, databases, GTM tech).
* [personal-brand.md](file:///home/abdulrahman/Projects/linkedin-content-os/prompts/personal-brand.md): Identity guidelines representing the Developer-Founder hybrid positioning.
* [system/knowledge-architect.md](file:///home/abdulrahman/Projects/linkedin-content-os/prompts/system/knowledge-architect.md): The instruction set for agents acting as knowledge managers/architects.

---

## 📂 Markdown Templates (`/templates`)
Reusable structures used by the developer to document facts, and by agents to output processed findings.

* [project-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/project-template.md): Template for documenting complex backend software builds.
* [story-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/story-template.md): Storytelling canvas for incident logs, post-mortems, and outages.
* [opinion-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/opinion-template.md): Reusable format to log controversial technical beliefs and opinions.
* [achievement-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/achievement-template.md): STAR-V framework to record performance wins and business outcomes.
* [technical-knowledge-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/technical-knowledge-template.md): Structure to document design patterns, database choices, and code scripts.
* [prompt-template.md](file:///home/abdulrahman/Projects/linkedin-content-os/templates/prompt-template.md): Standard layout to write system instructions for new AI agents.
